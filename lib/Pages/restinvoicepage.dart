...
class MyInvoiceRestPdf extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MyInvoiceRestPdfState();
  }
}

class MyInvoiceRestPdfState extends State<MyInvoiceRestPdf> {
  bool isEntered = false;
  bool isLoading = true;
  OrderHistoryRestaurant invoiceBeand;
  dynamic apCurrency;
  // dynamic appnamne;
                ...
                PDF.Container(
                  ...
                  child: PDF.Table.fromTextArray(
                      ...
                      data: <List<String>>[
                        ...
                        // <String>['${invoiceBean.store_Phone}'],
                      ],
                      border: PDF.TableBorder(
                        left: PDF.BorderSide.none,
                        top: PDF.BorderSide.none,
                ...
                PDF.Container(
                  ...
                  child: PDF.Table.fromTextArray(
                      ...
                      data: <List<String>>[
                        ...
                        <String>[
                          'ORDER DATE - ${invoiceBean.data[0].order_date}'
                        ],
                        <String>[
              ...
              child: PDF.Table.fromTextArray(
                  ...
                  data: <List<String>>[
                    ...
                    <String>[
                      'Delivery Charge',
                      '->',
                      ' $apCurrency. ${((invoiceBean.del_charge!=null || invoiceBean.del_charge!='null')?double.parse('${invoiceBean.del_charge}'):0.0)}'
                    ],
                    <String>[
                      'Paid By Wallet',
                      '->',
                    ...
                    <String>[
                      'Total',
                      '->',
                      ' $apCurrency. ${(double.parse('${invoiceBean.price}') + ((invoiceBean.del_charge!=null || invoiceBean.del_charge!='null')?double.parse('${invoiceBean.del_charge}'):0.0))}'
                    ],
                    <String>[
                      'Remaining Amount',
                      '->',
                      ' $apCurrency. ${invoiceBean.remaining_amount}'
                    ],
                  ],
                  border: PDF.TableBorder(
                    left: PDF.BorderSide.none,
  ...
  dynamic createDataPdf(List<ProductItemList> data) {
