...
//var imageBaseUrl = "https://delvfast.com/app/devapp/";
...
var editProfile = Uri.parse(baseUrl + "editmyprofile");
var addressCheck = Uri.parse(baseUrl + "address_check");
...
var searchUrl = Uri.parse(baseUrl + "searchKeyword");
...
var categoryBanner = (baseUrl + "categorybanner");
...
var ratingOrders = Uri.parse(baseUrl + "reviewrating");
...
var checkDelvmartVendor = (baseUrl + "check_vendor_time");
...
var privacypolicy =(baseUrl + "privacypolicy");
...
var cashfreeToken = Uri.parse(baseUrl + "cashfree_payment");
