...
class PaymentRestPage extends StatefulWidget {
  ...
  PaymentRestPage(this.vendor_ids, this.order_id, this.cart_id,
      this.totalAmount, this.tagObjs, this.addressDelivery);
...
class PaymentRestPageState extends State<PaymentRestPage> {
  ...
  void hitNavigator(cart_id, payment_method, payment_status, order_id,
    ...
    http.post(url, body: {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return OrderPlaced(
            payment_method, payment_status, cart_id, rem_price, currency, "2");
      }));
    }).catchError((e) {
      setState(() {
        showDialogBox = false;
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return OrderPlaced(
            payment_method, payment_status, order_id, rem_price, currency, "2");
      }));
    });
  }
  ...
  void paymongoCreatePaymentIntent(dynamic clientSceret, BuildContext context,
      int amount, String appCur) async {
