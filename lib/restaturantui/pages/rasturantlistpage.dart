              ...
              (nearStores != null && nearStores.length > 0)
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          if((nearStores[index].online_status == "on" || nearStores[index].online_status == "On" || nearStores[index].online_status == "ON")){
                            ...
                            Toast.show(locale.restaurantAreClosedNow, context,
                                duration: Toast.LENGTH_SHORT);
                          }
                        },
                              ...
                              Positioned(
                                ...
                                child: Visibility(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(locale.storeClosedNow,style: TextStyle(
                                        color: red_color
                                    ),),
                                  ),
                                ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      (!isFetchStore)
                          ? locale.noStoreFoundAtYourLocation
                          : locale.fetchingStores,
                      style: TextStyle(
                          fontSize: 18,
